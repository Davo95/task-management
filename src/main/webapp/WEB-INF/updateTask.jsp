...
<form action="/updateTask" method="post">
    ...
    <input type="text" placeholder="Description" name="description" value="<%=task.getDescription()%>">
    <input list="status" placeholder="Status" name="status" value="<%=task.getStatus()%>">
    <datalist id="status">
        <option value="IT">
